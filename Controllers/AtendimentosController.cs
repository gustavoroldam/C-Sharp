...
namespace WMVCADS2023.Controllers
{
    public class AtendimentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,data_hora")] Atendimento atendimento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,data_hora")] Atendimento atendimento)
        {
